        ...
        <section class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST">
                        <!-- Campo oculto para enlazar personalización -->
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="correo" class="form-control" type="email" name="correo" placeholder="ejemplo@correo.com">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="telefono" class="form-control" type="text" name="telefono" placeholder="3001234567">
                                </div>
                            </div>

                            <!-- Resumen de personalización si existe -->
                            <?php if (!empty($resumenPersonalizacion)): ?>
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        <h6 class="fw-bold mb-2"><i class="bi bi-gem me-2"></i>Tu selección:</h6>
                                        <ul class="mb-0">
                                            <?php foreach ($resumenPersonalizacion as $clave => $valor): ?>
                                                <li><strong><?= ucfirst($clave) ?>:</strong> <?= htmlspecialchars($valor ?? '-') ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                </div>
...
document.querySelector("form").addEventListener("submit", function(e) {
    ...
    if (correo === "" && telefono === "") {
        e.preventDefault();
        alert("Debes ingresar al menos un correo electrónico o un teléfono para poder contactarte.");
    }
});
</script>

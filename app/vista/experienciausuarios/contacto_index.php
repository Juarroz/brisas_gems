                ...
                <div class="accordion-item card shadow-sm">
                    ...
                    <div id="collapseFilters" class="accordion-collapse collapse">
                        <div class="accordion-body">
                            <form method="GET" action="/brisas_gems/public/contacto">
                                <div class="mb-3">
                                    <label>Vía</label>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="/brisas_gems/public/contacto" class="btn btn-sm btn-outline-secondary">Limpiar</a>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="nav flex-column nav-pills">
                <?php if (is_array($contactos) && !empty($contactos)): ?>
                    <?php foreach ($contactos as $index => $c): 
                        ...
                        $estadoClase = match ($c["estado"] ?? '') {
                            'atendido' => 'success',
                            'archivado' => 'secondary',
                            default => 'warning'
                        };
                    ?>
                        <button class="nav-link <?= $index === 0 ? 'active' : '' ?>" data-bs-toggle="pill" data-bs-target="#contact-<?= $id ?>">
            ...
            <div class="tab-content">
                <?php if (is_array($contactos)): ?>
                    <?php if (empty($contactos)): ?>
                        <div class="card card-body text-center"><p>No hay contactos para los filtros seleccionados.</p></div>
                    <?php else: ?>
                        <?php foreach ($contactos as $index => $c): 
                            $id = htmlspecialchars((string)($c["id"] ?? ''));
                        ?>
                            <div class="tab-pane fade <?= $index === 0 ? 'show active' : '' ?>" id="contact-<?= $id ?>">
                                <div class="card">
                                    ...
                                    <div class="card-footer bg-light">
                                        ...
                                        <form action="/brisas_gems/public/contacto/update" method="POST" class="row g-2 align-items-end">
                                            <input type="hidden" name="id" value="<?= $id ?>">
                                            <div class="col-md-4">
                                                <label class="form-label form-label-sm">Cambiar Estado</label>
                                            ...
                                            <div class="col-md-8">
                                                <label class="form-label form-label-sm">Añadir/Editar Notas</label>
                                                <textarea name="notas" class="form-control form-control-sm" rows="1" maxlength="500"><?= htmlspecialchars($c["notas"] ?? '') ?></textarea>
                                            </div>
                                        ...
                                        <form action="/brisas_gems/public/contacto/delete" method="POST" class="text-end mt-2" onsubmit="return confirm('¿Eliminar este contacto?');">
                                            <input type="hidden" name="id" value="<?= $id ?>">
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <div class="alert alert-danger"><p>No se pudo obtener la lista desde la API.</p></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="createContactModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="/brisas_gems/public/contacto/crear" method="POST">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="correo" class="form-control" maxlength="100" placeholder="(Opcional)">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="mensaje" class="form-control" required rows="4"></textarea>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12 form-check mb-3 ms-2">
                            <input type="checkbox" name="terminos" value="1" class="form-check-input" required id="terminosCheck">
